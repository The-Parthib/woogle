/**
 * Lightweight SVG icon components — eliminates the need for icon library dependencies.
 * All icons accept className for Tailwind styling.
 */

export function MessageSquareText({ className = "" }) {
  return (
    <svg
